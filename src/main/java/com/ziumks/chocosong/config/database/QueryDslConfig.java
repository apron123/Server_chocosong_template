...
public class QueryDslConfig {
    ...
    @PersistenceContext(unitName = DatabaseConstants.TargetDatabase.entity_manager_factory)
    ...
    /**
     * 타겟 데이터베이스를 위한 JPAQueryFactory 빈 생성
     *
     * @return JPAQueryFactory for the target database
     */
    @Bean("targetQueryFactory")
    public JPAQueryFactory targetJpaQueryFactory() {
        return new JPAQueryFactory(targetEntityManager);
    }
